...
from backtest import Backtester, Config, TailHedgeConfig, metrics, tail_hedge_metrics, print_metrics
...
def part3_signals(data):
    ...
    ax.axhline(0.90, color="green", ls="--", alpha=0.6, label="Buy threshold (0.90)")
    ax.axhline(1.30, color="red", ls="--", alpha=0.6, label="Sell threshold (1.30)")
